...
import com.mofidx.mykutupapp.reminder.ReminderAlarmService;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize Views
        mToolbar = (Toolbar) findViewById(R.id.toolbarreminder);
        ...
        mRepeatText.setText(" سيتم التكرار " + mRepeatNo + " مرة/ات كل " + mRepeatType + "");
...
//        alert.setTitle("التكرار");
//
//        // Create EditText box to input repeat number
//        final EditText input = new EditText(this);
//        input.setInputType(InputType.TYPE_CLASS_NUMBER);
//        alert.setView(input);
//        alert.setPositiveButton("موافق",
...
//    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.save_reminder:
                ...
                if (mTitleText.getText().toString().length() == 0){
                    mTitleText.setError("لا يمكن أن يكون عنوان المذكرة فارغًا!");
                }
            ...
            case android.R.id.home:
                ...
                // which is the {@link MainActivityAlarm}.
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            new ReminderAlarmService();
            ReminderAlarmService.cancelNotification(getApplicationContext(),42);
            new AlarmScheduler();
            AlarmScheduler.cancelAlarm(getApplicationContext(),mCurrentReminderUri);
...
//        Intent intent = new Intent(this, MainActivityAlarm.class);
...
*/
        ...
        // Check repeat type
//        if (mRepeatType.equals("دقيقة")) {
//            mRepeatTime = Integer.parseInt(mRepeatNo) * milMinute;
//        } else if (mRepeatType.equals("ساعة")) {
//            mRepeatTime = Integer.parseInt(mRepeatNo) * milHour;
//        } else if (mRepeatType.equals("يوم")) {
//            mRepeatTime = Integer.parseInt(mRepeatNo) * milDay;
//        } else if (mRepeatType.equals("اسبوع")) {
//            mRepeatTime = Integer.parseInt(mRepeatNo) * milWeek;
//        } else if (mRepeatType.equals("شهر")) {
